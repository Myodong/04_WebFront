...
document.getElementById("add").addEventListener("click",function(){
    ...
    // div.append(input,)
    // div.append(span,)
    div.append(input,span,) //한번에 작성 가능
...
// -> 안됨...
// 왜>
// 처음 HTML 문서 해석지 remove 라는 클래스를 가진 요소가 존재하지 않기 때문에
// 아래 이벤트 동작 추가 구분에 아무 요소에 적용되지 않음
...
document.getElementById("calc").addEventListener("click",function(){
    ...
    // 함수는 호출된 시점의HTML 화면을 기반으로해서 해석 진행!!!
...
// input = document.getElementsByClassName("in")

// input = 0;

// for(let item of input.value){
//     item +
// }
