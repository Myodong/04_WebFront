...
document.getElementById("btn1").addEventListener("click",function(){
    ...
    // 자식 관련
    // 요소.childNodes : 요소의 자식 노드를 모두 반환(NodList 형태)
    // 요소.firstChuld : 첫 번째 자식 노드 탐색해서 반환
    // 요소.lastChuld  : 마지막  자식 노드 탐색해서 반환
    // 요소.childNodes[인덱스] : 인덱스 번째 자식 노드를 모두 탐색해서 반환
    ...
    // #test의 자식 노드 중 6번 인덱스 노드의 마지막 자식으로 "ZZZ" 추가하기
    ...
    // #test의 자식 노드 중 5번 인덱스의 다음 형제 노드의 다음 형제 노드
    console.log(test.childNodes[5].nextSibling.nextSibling);
})
