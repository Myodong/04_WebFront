...
document.getElementById("check1").addEventListener("click",function(){
    ...
    const str2 = "java, db, html, css, js, mybatis 모두 사용중입니다.";
...
document.getElementById("check2").addEventListener("click",function(){
    ...
    div1.innerHTML+="/[abcd],apple : " + regEx1.test("qwerty")+"<hr>";
    ...
    // ^[ABCD]-team$
    // -> A-team / b-team / C-team / D-team 이 맞으면 true / 아님false
...
document.getElementById("inputName").addEventListener("keyup",function(){
    ...
    if(regEx.test(this.value)){ //유효하면
        ...
        // result1.style.color="green"; 적용 순위가 2순위라 방식이라 문제 생길수도있음
        ...
        // result1.style.color="red"; 적용 순위가 2순위라 방식이라 문제 생길수도있음
